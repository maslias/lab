...
func (x *ItemsWithQantity) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemsWithQantity) ProtoMessage() {}

func (x *ItemsWithQantity) ProtoReflect() protoreflect.Message {
	mi := &file_api_oms_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemsWithQantity.ProtoReflect.Descriptor instead.
func (*ItemsWithQantity) Descriptor() ([]byte, []int) {
	return file_api_oms_proto_rawDescGZIP(), []int{2}
}

func (x *ItemsWithQantity) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ItemsWithQantity) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
type CreateOrderRequest struct {
	...
	Items      []*ItemsWithQantity `protobuf:"bytes,2,rep,name=Items,proto3" json:"Items,omitempty"`
}
...
func (x *CreateOrderRequest) GetItems() []*ItemsWithQantity {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_api_oms_proto_rawDesc = []byte{
	...
	0x07, 0x50, 0x72, 0x69, 0x63, 0x65, 0x49, 0x64, 0x22, 0x3e, 0x0a, 0x10, 0x49, 0x74, 0x65, 0x6d,
	0x73, 0x57, 0x69, 0x74, 0x68, 0x51, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x28, 0x09, 0x52, 0x0a, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x49, 0x64, 0x12, 0x2b,
	0x0a, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x57, 0x69, 0x74, 0x68, 0x51, 0x61, 0x6e,
	...
	0x1f, 0x5a, 0x1d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x61,
	0x73, 0x6c, 0x69, 0x61, 0x73, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x61, 0x70, 0x69,
...
var file_api_oms_proto_goTypes = []any{
	...
	(*Item)(nil),               // 1: api.Item
	(*ItemsWithQantity)(nil),   // 2: api.ItemsWithQantity
...
var file_api_oms_proto_depIdxs = []int32{
	...
	2, // 1: api.CreateOrderRequest.Items:type_name -> api.ItemsWithQantity
